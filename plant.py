...
def predtext(inp):
    ...
    openai.api_key = "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"
...
with col1:               
    ...
    st.markdown('<p class="font">PLANT DISEASE DETECTION</p>', unsafe_allow_html=True)
with col2:
    st.image(image,  width=380)
st.markdown('<p class="font1"></p>', unsafe_allow_html=True)
